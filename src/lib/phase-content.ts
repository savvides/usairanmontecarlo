...
export const phaseContent: PhaseContent[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Iran\'s response, designated Operation True Promise IV, was neither measured nor delayed. Within hours of the initial strikes, Iran demonstrated that it had achieved at least some degree of decentralization in decision-making: even the death of the Supreme Leader and most military commanders did not prevent a strong response. The IRGC Aerospace Force launched more than 500 ballistic and cruise missiles at US military installations across Iraq, Qatar, Bahrain, and the UAE, accompanied by approximately 2,000 drones. Targets included Bahrain\'s capital Manama, the Saudi capital Riyadh, Abu Dhabi, and Kuwait International Airport. Iran chose an "if we burn, everyone burns" strategy, striking Gulf allies to increase the cost of war beyond just the US and Israel. The scale and simultaneity of this retaliation exceeded any previous Iranian missile salvo and demonstrated that survivable launch capacity had been preserved despite the initial strikes. Several US forward operating bases sustained significant damage; casualties among American servicemembers were in the dozens, triggering automatic escalation protocols under rules of engagement.',
